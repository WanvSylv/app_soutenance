<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto animate-fade-in">
        ...
        <div class="glass-card p-10">
            <form action="{{ route('admin.etudiants.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8" x-data="{ photoPreview: null }">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="group">
                        ...
                        <x-text-input id="email" name="email" type="email" class="block w-full" :value="old('email')" required placeholder="etudiant@horebip.com" />
                ...
                <div class="pt-8 border-t border-[#F4F7FE]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="group">
                            ...
                            <x-text-input id="matricule" name="matricule" type="text" class="block w-full" :value="old('matricule')" required placeholder="Ex: 2026IP001" />
                        ...
                        <div class="group">
                            ...
                            <select id="niveau" name="niveau" class="mt-1 block w-full border-[#E0E5F2] bg-[#F4F7FE] text-[#1B254B] focus:border-[#2D60FF] focus:ring-[#2D60FF]/10 rounded-[1.25rem] shadow-sm transition-all duration-300 font-semibold" required>
                                ...
                                <option value="Licence 3 (Bachelor)" {{ old('niveau') == 'Licence 3 (Bachelor)' ? 'selected' : '' }}>Licence 3 (Bachelor)</option>
                    ...
                    <div class="group mt-8">
                        ...
                        <select id="filiere" name="filiere" class="block w-full select2-field" required>
                            ...
                            <option value="Cybersécurité" {{ old('filiere') == 'Cybersécurité' ? 'selected' : '' }}>Cybersécurité</option>
                            <option value="Réseaux et Télécommunications" {{ old('filiere') == 'Réseaux et Télécommunications' ? 'selected' : '' }}>Réseaux et Télécommunications</option>
                            <option value="Intelligence Artificielle" {{ old('filiere') == 'Intelligence Artificielle' ? 'selected' : '' }}>Intelligence Artificielle</option>
                            <option value="Data Science" {{ old('filiere') == 'Data Science' ? 'selected' : '' }}>Data Science</option>
                            <option value="Informatique de Gestion" {{ old('filiere') == 'Informatique de Gestion' ? 'selected' : '' }}>Informatique de Gestion</option>
                            <option value="Développement Web et Mobile" {{ old('filiere') == 'Développement Web et Mobile' ? 'selected' : '' }}>Développement Web et Mobile</option>
                        </select>
        ...
        <p class="mt-6 text-center text-[#A3AED0] text-sm font-medium italic">
            * Un mot de passe sécurisé sera généré aléatoirement et devra être communiqué à l'étudiant.
        </p>
    </div>
</x-app-layout>
